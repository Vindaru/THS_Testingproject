...
public class HomePageTest extends BaseTest{
  ...
  //HomePage
   ...
   //HomePage header
	...
	Thread.sleep(300);
	// homepage
   // verify menu tabs consists of HOME, PORTAL, POLICY MANAGMENT, ADMIN, HELP  // PORTAL QUOTES POLICY MANAGEMENT ADMIN HELP 
	...
	// test Agency Override label displaying	
	Thread.sleep(300);
	BasicInformationPage basicinformationpage = page.getInstance(HomePage.class).doSelectStateByDataprovided(stateSelect);	
	Thread.sleep(300);
