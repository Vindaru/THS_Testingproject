...
public class BasicInformationPage extends BasePage{
    ...
    private static  Logger log = Logger.getLogger(BasicInformationPage.class.getName()+" ----------------------------------");

    
   private By header                       = By.xpath("//*[@id='addressValidator']/div[1]/div");
   private By BusinessOwned_lable          = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[1]/div[1]/div[1]/label");
   private By InsuredFirstName_lable       = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[1]/div[1]/div[2]/div/label/span[1]");
   private By InsuredLastName_lable        = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[1]/div[1]/div[2]/label/span[1]");
   private By InsuredAddress_lable         = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[1]/div[2]/label[1]/span[1]");
   private By InsuredCity_lable            = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[1]/div[2]/label[3]/span[1]");
   private By InsuredState_lable           = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[1]/div[2]/label[4]/span[1]");
   private By InsuredZipcode_lable         = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[1]/div[2]/label[5]/span[1]");
   private By InsuredDOB_lable             = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[2]/label[1]/span[1]");
   private By Occupancy_lable              = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[2]/div[2]/label[2]/span[1]");
   private By Fire_Hyderant_lable          = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[4]/div/label");
   private By validateButton               = By.xpath("/html/body/div[1]/div[4]/div[1]/div[2]/div/div[2]/div/form/section/div[5]/span");  
...
return ;	
   ...
   public void doBasicinformationPagevalidation(
	   String firstname,
	   String lastname,
	   String address,
	   String city,
